  ...
  return (
    <div className="pb-40">
      <div className="max-w-[1240px] px-5 mx-auto">
        ...
        <div className="grid place-items-center md:pt-32 pt-10 max-[640px]:text-center lg:grid-cols-5 sm:grid-cols-3 grid-cols-1 gap-y-10 text-xl text-secondary font-extrabold md:-mt-10">
          {["Chhapar", "Nimriwali", "Jui", "Nandgaon", "Dinod"]?.map(
