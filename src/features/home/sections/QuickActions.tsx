...
const QuickActions = () => {
  return (
    <div className='flex items-center justify-center flex-wrap gap-x-10 gap-y-16 pt-10 px-5 pb-72'>
      <div className='max-w-[303px] w-full min-h-[195px] p-[30px] space-y-3 border hover:border-black shadow-[8px_8px_0px_0px_#eee] hover:shadow-[10px_10px_0px_0px_#000] duration-500'>
